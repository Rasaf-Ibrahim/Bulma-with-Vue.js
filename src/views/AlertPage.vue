...
export default {
    ...
    components: {Alert, CodeLink, Footer},
    ...
    data() {
        ...
        link: "https://github.com/Rasaf-Ibrahim/Some-Designed-Components/blob/master/src/components/alert/Alert.vue"
