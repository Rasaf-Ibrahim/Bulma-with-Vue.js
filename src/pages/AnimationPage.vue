...
<main class="p-8">
    ...
    <div>
        ...
        <CodeLink :link="LinkFade"  :name="NameFade"/>
    </div>
   ...
   <!-- Pop -->
    <div>
        ...
        <CodeLink :link="LinkPop"  :name="NamePop"/>
    </div>
...
export default {
    ...
    data() {
        ...
        NameFade: 'Fade Animation',

        LinkFade: "https://github.com/Rasaf-Ibrahim/Some-Designed-Components/blob/master/src/components/animation/Fade.vue",

      

        
        NamePop: 'Pop Animation',

        LinkPop: "https://github.com/Rasaf-Ibrahim/Some-Designed-Components/blob/master/src/components/animation/Pop.vue"
