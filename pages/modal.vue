...
<main class="p-9">
    ...
    <Modal/>
     ...
     <CodeLink :link="LinkModal"  :name="NameModal"/>
...
import Footer from '../components/Footer.vue'
  ...
  export default {
      ...
      components: {Modal,CodeLink,Footer},
    ...
    data() {
        ...
        LinkModal: "https://github.com/Rasaf-Ibrahim/Some-Designed-Components/blob/master/src/components/modal/Modal.vue"
       }
    },
