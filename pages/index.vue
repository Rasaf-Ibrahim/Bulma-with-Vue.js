    ...
    <div>
      ...
      <main>
        ...
        <div class="bg-s-t1a2 p-8 my-4 flex justify-center">
          <svg
            class="w-full md:w-3/4 h-64"
            id="b06587d5-0dba-482d-8c16-9624be0edba5"
            data-name="Layer 1"
          ...
          >
            <defs>
              <linearGradient
                id="a2d550d8-b94a-4b4e-8cdf-b12633d149de"
                x1="499.26"
                y1="786.28"
                x2="499.26"
                y2="342.21"
              ...
              <linearGradient
                id="a292624c-a529-40fd-b6b9-058cc3ca33ba"
                x1="1707.38"
                y1="783.9"
                x2="1707.38"
                y2="326.53"
            ...
            />
            <path
              d="M743.86,380.54a4.84,4.84,0,0,1-1.76.65,5.64,5.64,0,0,1-4.67-.7"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
            ...
            />
            <path
              d="M254.29,415.31c.08-.32-8.1,8-10.29,9.27S252,424.51,254.29,415.31Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M231.52,472.36s-12.48,8.07-10.84,11.26S231.52,472.36,231.52,472.36Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M254.18,590.16s10.63,6.84,27.16,8.54Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M228.67,606.59S238.53,619,243,619.29,228.67,606.59,228.67,606.59Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M242.47,655.09c-.44.22-5.59,11.17-10.84,11.5S242.47,655.09,242.47,655.09Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M288.12,679.07s9.77-2.19,11.94,4.82C300.06,683.89,299.4,681.7,288.12,679.07Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M281.56,719.14s11.82-2.41,14.34.88S281.56,719.14,281.56,719.14Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
            ...
            />
            <path
              d="M277.61,735.13s19.79-2.41,18.54,1.75S277.61,735.13,277.61,735.13Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M174,491.41c.11.33,13,2.08,14.78,6.24,0,0-12.7-5.91-14.67-5.91"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M192.21,525.24s-10.73,3.39-10,8.54S181.16,531.38,192.21,525.24Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M187.21,551.3s3.91-5.37,7.63-4.38S187.21,551.3,187.21,551.3Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
            ...
            />
            <path
              d="M236.51,755s3.85,4.93,2.86,7.72S236.51,755,236.51,755Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
            ...
            />
            <path
              d="M225,416.7l10.8-7.6s-15.85-9.36-17.74-8.05-3.18,13.15-3.18,13.15Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M224.92,416.2l10.84-7.76s-15.85-9.36-17.74-8-3.18,13.8-3.18,13.8Z"
              transform="translate(-95.95 -60.22)"
              fill="#e1e7ef"
            />
            <path
            ...
            />
            <path
              d="M252.19,411.89l-13.51-5s17.2-18.83,19.34-8.38Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
              d="M252.19,411.23l-13.51-5s17.2-18.84,19.34-8.39Z"
              transform="translate(-95.95 -60.22)"
              fill="#e1e7ef"
            />
            <path
            ...
            />
            <path
              d="M251.75,395.22a.77.77,0,0,1,.56.11Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
            ...
            />
            <path
              d="M281.45,421.12c.87.54,4.7,9.63,2.95,13.35S281.45,421.12,281.45,421.12Z"
              transform="translate(-95.95 -60.22)"
              opacity="0.1"
            />
            <path
        ...
        <div class="bg-s-t1a2 p-8 my-4 flex justify-center">
          ...
          >
            ...
            <ellipse cx="226" cy="537" rx="70" ry="5.33898" fill="#e6e6e6" />
            <path
            ...
            <path
              ...
              fill="#3f3d56"
            />
            <circle cx="341" cy="288" r="19" fill="#DB2777" />
            <circle cx="56" cy="415" r="19" fill="#DB2777" />
            <path
            ...
            <path
              ...
              fill="#3f3d56"
            />
            <circle cx="568.97297" cy="475.93056" r="43.06733" fill="#2f2e41" />
            <rect
              x="575.51484"
              y="509.73025"
              width="13.08374"
            ...
            <ellipse
              ...
              fill="#2f2e41"
            />
            <circle cx="567.88264" cy="465.02746" r="14.71922" fill="#fff" />
            <circle cx="567.88264" cy="465.02746" r="4.90642" fill="#3f3d56" />
            <path
            ...
            <path
              ...
              fill="#2f2e41"
            />
            <circle cx="68.33625" cy="179.05228" r="14.71922" fill="#fff" />
            <circle cx="68.33625" cy="179.05228" r="4.90642" fill="#3f3d56" />
            <path
            ...
            <ellipse
              ...
              fill="#2f2e41"
            />
            <circle cx="581.96808" cy="344.64255" r="42.01233" fill="#2f2e41" />
            <rect
              x="866.8304"
              y="556.38495"
              width="12.76324"
            ...
            <ellipse
              ...
              fill="#2f2e41"
            />
            <circle cx="580.85505" cy="334.01157" r="14.35864" fill="#fff" />
            <circle cx="575.93651" cy="327.91867" r="4.78622" fill="#3f3d56" />
            <path
